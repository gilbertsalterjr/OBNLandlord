...
{
    public class TokenService(UserManager<ApplicationUser> userManager, OBNTenantInfo tenant, IOptions<JwtSettings> jwtSettings) : ITokenService
    {
        ...
        private ClaimsPrincipal GetClaimsPrincipalFromExpiredToken(string expiredToken)
        {
            ...
            {
                throw new UnauthorizedException("Invalidd token.  Failed to create refresh token.");
            }
